 ...
 * @Date: 2026-07-10 21:18:05
 * @LastEditors: kamalyes 501893067@qq.com
 * @LastEditTime: 2026-07-10 21:18:05
 * @FilePath: \go-llmx\embeddings\mistral\errors.go
 * @Description: Mistral 嵌入适配器错误差异 —— wire 错误体解析 + Classifier 实现.
